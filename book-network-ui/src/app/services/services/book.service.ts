...
import { approuveReturnBorrowBook } from '../fn/book/approuve-return-borrow-book';
import { ApprouveReturnBorrowBook$Params } from '../fn/book/approuve-return-borrow-book';
...
import { uploadBookCouverPicture } from '../fn/book/upload-book-couver-picture';
import { UploadBookCouverPicture$Params } from '../fn/book/upload-book-couver-picture';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `uploadBookCouverPicture()` */
  static readonly UploadBookCouverPicturePath = '/books/cover/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `uploadBookCouverPicture()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  uploadBookCouverPicture$Response(params: UploadBookCouverPicture$Params, context?: HttpContext): Observable<StrictHttpResponse<{
}>> {
    return uploadBookCouverPicture(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `uploadBookCouverPicture$Response()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  uploadBookCouverPicture(params: UploadBookCouverPicture$Params, context?: HttpContext): Observable<{
}> {
    return this.uploadBookCouverPicture$Response(params, context).pipe(
  ...
  /** Path part for operation `approuveReturnBorrowBook()` */
  static readonly ApprouveReturnBorrowBookPath = '/books/borrow/return/approuve/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `approuveReturnBorrowBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  approuveReturnBorrowBook$Response(params: ApprouveReturnBorrowBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return approuveReturnBorrowBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `approuveReturnBorrowBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  approuveReturnBorrowBook(params: ApprouveReturnBorrowBook$Params, context?: HttpContext): Observable<number> {
    return this.approuveReturnBorrowBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
